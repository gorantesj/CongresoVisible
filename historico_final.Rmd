...
```
```{r  partidos-mayor-representacion-1, echo =FALSE}
...
```{r partidos-mayor-representacion-2, echo =FALSE}
...
# Número de iniciativas gubernamentales por cuatrienio  ---------------------------------------
 ...
 aux <- proyecto_final %>%
    ...
    aux %>% # Ordenar por factores la y
      hchart('bar', hcaes(x = 'cuatrienio', y = n, group = 'cuatrienio')) %>%
...
cuat1 <- aux %>% 
         filter(cuatrienio=="Cuatrienio 1998")

cuat2 <- aux %>% 
         filter(cuatrienio=="Cuatrienio 2002")
cuat3 <- aux %>% 
         filter(cuatrienio=="Cuatrienio 2006")
cuat4 <- aux %>% 
         filter(cuatrienio=="Cuatrienio 2010")
cuat5 <- aux %>% 
         filter(cuatrienio=="Cuatrienio 2014")
cuat6 <- aux %>% 
         filter(cuatrienio=="Cuatrienio 2018")
  ...
  density(cuat1$edad), 
  type = "area", 
  color = "#66CCFF", name = "Cuatrienio 1998"
  ) %>% 
  hc_add_series(
  density(cuat2$edad), 
  type = "area", 
  color = "#17789E", name = "Cuatrienio 2002"
  )%>% 
  hc_add_series(
  density(cuat3$edad), 
  type = "area", 
  color = "#6AEEB0", name = "Cuatrienio 2006"
  )%>% 
  hc_add_series(
  density(cuat4$edad), 
  type = "area", 
  color = "#379E80", name = "Cuatrienio 2010"
  ) %>%
