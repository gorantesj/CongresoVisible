...
cuatri <- read_csv(here("Para Jesús", "cuatrienios.csv")) %>% 
          ...
          arrange(fecha_inicio_cuatri) %>% 
          mutate(cuatrienio=row_number(), 
                 cuatrienio=factor(cuatrienio, labels = c("Cuatrienio 1994", "Cuatrienio 1998", 
                                                           "Cuatrienio 2002", "Cuatrienio 2006", 
                                                           "Cuatrienio 2010", "Cuatrienio 2004", 
                                                           "Cuatrienio 2008")))  
...
proyecto <- read_csv(here("Para Jesús", "proyecto_leys.csv")) %>% 
            ...
            left_join(cuatri, by=c("cuatrienio_id"="id")) %>% 
